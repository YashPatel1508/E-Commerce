...
export default function Register() {
    ...
    return (
        <div className="min-h-[80vh] flex items-center justify-center px-4 bg-slate-50 pt-20 pb-10">
            <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl w-full max-w-md border border-gray-100">
                ...
                <h2 className="text-3xl font-display font-medium text-luxury-black text-center mb-8">Create Account</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-xs font-semibold text-luxury-charcoal uppercase tracking-wider mb-2">First Name</label>
                            <input 
                                type="text" required
                        ...
                        <div>
                            <label className="block text-xs font-semibold text-luxury-charcoal uppercase tracking-wider mb-2">Last Name</label>
                            <input 
                                type="text" required
                                className="w-full px-4 py-3 border border-luxury-gray/20 bg-gray-50 focus:bg-white focus:ring-1 focus:ring-luxury-gold focus:border-luxury-gold outline-none transition font-light text-sm"
                    ...
                    <div className="text-center mt-6">
                        <p className="text-sm text-luxury-gray font-light">
                            Already have an account? <Link to="/login" className="text-luxury-black font-medium hover:text-luxury-gold transition border-b border-transparent hover:border-luxury-gold pb-0.5">Sign In</Link>
                        </p>
                    </div>
                </form>
            </div>
